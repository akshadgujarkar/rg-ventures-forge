...
>((props, ref) => {
  ...
  const { question, answer, index, Icon, color } = props;
  ...
  return (
    ...
    >
      <Button
        ...
        className="w-full px-6 py-4 h-auto justify-between hover:bg-transparent flex items-center gap-3"
      >
        {Icon &&
          <div className={`p-3 ${color} rounded-lg w-fit mb-2`}>
        ...
        <motion.div
          ...
          className={cn(
            "ml-auto p-0.5 rounded-full flex-shrink-0",
